...
class Event extends Component {
  ...
  changeRegistrationStatus = registrationStatusOfEvent => {
    this.setState({
      registrationStatus: registrationStatusOfEvent,
    })
      ...
      <div className="main-container">
        <div className="events-container">
          ...
          <ul className="event-items-container">
            {eventsList.map(eventListElem => (
              <EventItem
                eventListElem={eventListElem}
                changeRegistrationStatus={this.changeRegistrationStatus}
                key={eventListElem.id}
              />
            ))}
          </ul>
        </div>
